...
const ServicesGrid = () => {
  const services = [
    ...
    {
      id: 3,
      icon: '/icons/luckylinkmanager.svg',
    ...
    {
      id: 5,
      icon: '/icons/LuckyIntelligence.svg',
    ...
    {
      id: 6,
      icon: '/icons/luckysecurityscan.svg',
